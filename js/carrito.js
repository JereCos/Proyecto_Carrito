...
//Tarjetas creadas a partir de un JSON
mostrarProductos();
        ...
        tarjetaHtml = `
            <div class="row">
                ...
                <div class="card">
                    ...
                    <a href="#" class="waves-effect waves-light agregar-carrito btn" data-id="${producto.id}">Agregar al carrito</a>
                    </div>
                </div>
                </div>
            </div>
...
function leerDatosProducto(producto) {
    ...
    const titulo = producto.querySelector('span').textContent;
    const precio = producto.querySelector('.card-content').textContent;
